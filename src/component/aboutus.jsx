...
import Vission from '../assets/img/about/mission.jpg'
      ...
      <section className='about-sec'>
        <div className='container'>
          <div className='row align-items-center'>
            <div className='col-md-8 col-12'data-aos="fade-up"data-aos-offset="10">
              <h2> About Us</h2>
            ...
            <div className="col-md-4 col-12 h-100"data-aos="fade-up"data-aos-offset="0">
                <img alt='aboutimg' src={Aboutimg} className="img-fluid h-100" />
            </div>
          </div>
        </div>
       </section>
       <section className='mision-sec bg-l-grenn text-white'>
        <div className="container">
         <div className="row align-items-center justify-content-center">
             <div className=" col-xl-7 col-lg-6 col-md-12" data-aos="fade-right" data-aos-offset="10">
              <img  alt ="vission" src={Vission} className='vision-img mb-3 mb-md-0' />
             </div>
